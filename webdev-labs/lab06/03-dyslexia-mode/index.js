...
const dyslexiaTrigger = () =>{
  var cur = document.querySelector('body').className;
  if(cur != 'dyslexia-mode'){
...
document.getElementById('dyslexia-toggle').addEventListener('click', dyslexiaTrigger);
